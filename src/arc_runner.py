...
if __name__ == "__main__":
    ...
    if len(cl_args) != 3:
        logger.error("Usage: python arc_runner.py file_extension operation [file_extension must be a string and operation must be an integer 1, 2 or 3]")
        sys.exit(1)
    ...
    try:
        ...
        if operation not in range(1,4) or not isinstance(cl_args[1], str):
            raise ValueError
